				...
				<div class="panel panel-default">
							<div class="panel-body">
								<div class="form-group has-success">
									<label>Name</label>
									<input type="text" class="form-control" style="width: 40%" placeholder="Name" name="name" required><br>
									<label>Father Name</label>
									<input type="text" class="form-control" style="width: 40%" placeholder="Father Name" name="fname" required><br>

									<label>UOB</label>
									<input type="text" class="form-control" style="width: 40%" placeholder="UOB" name="uob" required><br>

									<label>CNIC</label>
									<input type="text" class="form-control" style="width: 40%" placeholder="CNIC" name="cnic" required><br>

									<label>Department</label>
									<select class="form-control" name="department" style="width: 40%" required>
