...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="displaygroups.php"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Display Group</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Display Groups</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Display Groups</div>
						...
						<div class="RackList">
							<?php 
								...
								if ($_SERVER["REQUEST_METHOD"] == "POST") {
									...
									$_SESSION['edit_group_year']=$cl;
								}

								
								$sql = "SELECT * FROM student_data WHERE year = '$cl' order by groupno DESC";
								$result = $conn->query($sql);

								if ($result->num_rows > 0) {
    
									echo "<table class='table table-hover'>";
									echo "<thead><tr> <th>Name</th><th>Father Name</th><th>UOB</th><th>CNIC</th><th>Department</th><th>Year</th><th>Group Name</th></tr></thead><tbody>";
    									while($row = $result->fetch_assoc()) {
        									...
        									$sqlgroup = "SELECT * FROM groups WHERE year = '$cl' and id=$test";
											$gresult = $conn->query($sqlgroup);
											if ($grow= mysqli_fetch_row($gresult)) {
												$gname=$grow[1];
											}
											else {$gname="Unallocated";}
        									...
        									?>
        									 ...
        									 <td>
        									 	<a href="delete_from_group_process.php?id=<?=$row['id']?>"> <input type="button" value="Delete" class="btn btn-default btn-md pull-right"></a>	
